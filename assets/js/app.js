...
const IVT_APP = (() => {
    ...
    container.innerHTML = `
      <div class="vitrine__stage">
        ...
        <div class="vitrine__info">
          ...
          <a class="btn btn--ghost btn--sm vitrine__cta">Voir la fiche →</a>
        </div>
      </div>
  ...
  return {
    ...
    imageDe, animerNombre, creerVitrine, creerHero, creerTicker, initTickerBar, badgeVariation, lienWhatsApp,
