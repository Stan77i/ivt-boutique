...
window.IVT = {
  ...
  produits: [
    ...
    },
    {
      ...
      unite: 'kg', colis: 'Carton de 10 kg', origine: 'Import',
      note: 'Têtes sèches, gousses pleines. Conditionnement carton pour longue conservation.',
      prix: [1850, 1880, 1920, 1980, 2050, 2120, 2080, 2020, 1980, 1950]
    },
    {
    ...
    /* ---------------------- FRUITS ---------------------- */
    {
      slug: 'papaye', nom: 'Papaye', categorie: 'fruits',
      unite: 'kg', colis: 'Cageot de 20 kg', origine: 'Azaguié · Tiassalé',
      note: 'Papaye solo, chair orangée et sucrée. Expédiée au stade tournant.',
      prix: [300, 310, 320, 335, 360, 380, 370, 355, 340, 330]
    },
    {
    ...
    },
    {
      ...
      unite: 'kg', colis: 'Régime / carton 18 kg', origine: 'Azaguié · Dabou',
      note: 'Banane dessert, doigts bien formés. Livrée verte ou mûre sur demande.',
      prix: [390, 400, 415, 435, 465, 490, 475, 455, 440, 430]
    },
    {
